...
<div class="right">
        ...
        <div class="search">
        	<form method="get" action="${pageContext.request.contextPath }/pro/list">
				...
				<a href="${pageContext.request.contextPath }/jump/provideradd">添加供应商</a>
			</form>
        </div>
        <!--供应商操作表格-->
        <table class="providerTable" cellpadding="0" cellspacing="0">
            ...
            <c:forEach var="provider" items="${proPageInfo.list }" varStatus="status">
				<tr>
					<td>
		...
		<input type="hidden" id="totalPageCount" value="${proPageInfo.pages}"/>
		<c:import url="rollpage.jsp">
			<c:param name="totalCount" value="${proPageInfo.total}"/>
			<c:param name="currentPageNo" value="${proPageInfo.pageNum}"/>
			<c:param name="totalPageCount" value="${proPageInfo.pages}"/>
		</c:import>
    </div>
</section>
